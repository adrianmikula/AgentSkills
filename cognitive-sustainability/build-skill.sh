...
SKILL_NAME="cognitive-sustainability-skill"
...
# Copy policy files into flat resources/ folder
cp "${SCRIPT_DIR}/10-policies/human-decision-boundaries.md"    "${STAGING_DIR}/resources/"
cp "${SCRIPT_DIR}/10-policies/architecture-synchronization.md" "${STAGING_DIR}/resources/"
cp "${SCRIPT_DIR}/10-policies/automation-intensity-control.md"  "${STAGING_DIR}/resources/"
...
bash "${SCRIPT_DIR}/../scripts/setup-agent-links.sh" "cognitive-sustainability"
