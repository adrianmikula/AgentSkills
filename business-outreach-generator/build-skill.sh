...
# Copy all resource policy files into flat resources/ folder
cp "${SCRIPT_DIR}/resources/"*.md "${STAGING_DIR}/resources/"
...
bash "${SCRIPT_DIR}/../scripts/setup-agent-links.sh" "business-outreach-generator"
